...
namespace ExtensionMethods
{
    ...
    public static class ComplexExtensions
    {
        ...
        {
            return new Complex((c1.Real * c2.Real) - (c1.Imaginary * c2.Imaginary), (c1.Imaginary * c2.Real) + (c2.Imaginary * c1.Real));
        }
        ...
        public static IComplex Divide(this IComplex c1, IComplex c2)
        {
            ...
            Double numR = (c1.Real * c2.Real) + (c1.Imaginary * c2.Imaginary);
            double numI = (c1.Imaginary * c2.Real) - (c1.Real * c2.Imaginary);
